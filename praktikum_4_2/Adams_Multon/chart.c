...
void print_line() {
    ...
    fprintf(pipe, "cd 'D:\\msu\\program_msu\\test_m\\cmake-build-debug'\n");
    ...
    fprintf(pipe, "plot 'istina.txt'  w l lw 2 lc rgb '#000000' lt 1 ti 'Y',\'istina.txt' u 1:3 w l lw 2  lc rgb '#00ff00' lt 1 ti 'F''\n");
