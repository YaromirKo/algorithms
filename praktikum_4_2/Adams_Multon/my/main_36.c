...
#include <math.h>
#include <time.h>
/// Метод сведение уравнения к системе второго порядка, нахождения решения этой системы ДУ метод Адамса-Мултона и используя метод Ньютона для решения уравнений
