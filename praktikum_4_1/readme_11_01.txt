...
Функции в файле sim_11_01.с:
 ...
 void print_m_tmp(int n, double * tmp) - печать дополнительной матрицы, которая используется для перменожения 2х матрицы, n * n  размерности.
 										 Аргументы: размерность матрицы, массив tmp. 

  int sim_11_01(int n, double * A, double * tmp, double precision) - модуль упрощения, сводящий входную матрицу A к почти треугольному виду унитарным подобием методом отражений.
  																	 Аргументы: размерность n, матрица A, массив дополнительной памяти 
